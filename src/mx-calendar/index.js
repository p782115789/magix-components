...
module.exports = Magix.View.extend({
    tmpl: {"html":"<div class=\"mx3e3-_mx-calendar_index_-wrapper mx3e3-_mx-style_index_-unselectable\"><div mx-guid=\"g0\u001f\" id=\"days_<%=$$.id%>\" class=\"mx3e3-_mx-style_index_-clearfix\">1\u001d</div><div mx-guid=\"g5\u001f\" id=\"months_<%=$$.id%>\" class=\"mx3e3-_mx-style_index_-clearfix mx3e3-_mx-calendar_index_-m-panel\"><div class=\"mx3e3-_mx-calendar_index_-header\"><span class=\"mx3e3-_mx-style_index_-iconfont mx3e3-_mx-calendar_index_-minus\" mx-click=\"\u001f\u001echangeYear()\">&#xe61e;</span><h4 mx-guid=\"g6\u001f\" mx-click=\"\u001f\u001eshowYears()\" class=\"mx3e3-_mx-calendar_index_-title\">7\u001d</h4><span class=\"mx3e3-_mx-style_index_-iconfont mx3e3-_mx-calendar_index_-plus\" mx-click=\"\u001f\u001echangeYear({next:true})\">&#xe61b;</span></div><div mx-guid=\"g7\u001f\" class=\"mx3e3-_mx-calendar_index_-body\">8\u001d</div></div><div mx-guid=\"g8\u001f\" id=\"years_<%=$$.id%>\" class=\"mx3e3-_mx-style_index_-clearfix mx3e3-_mx-calendar_index_-y-panel\"><div class=\"mx3e3-_mx-calendar_index_-header\"><span class=\"mx3e3-_mx-style_index_-iconfont mx3e3-_mx-calendar_index_-minus\" mx-click=\"\u001f\u001echangeYear({range:true})\">&#xe61e;</span><h4 mx-guid=\"g9\u001f\" class=\"mx3e3-_mx-calendar_index_-title\">10\u001d</h4><span class=\"mx3e3-_mx-style_index_-iconfont mx3e3-_mx-calendar_index_-plus\" mx-click=\"\u001f\u001echangeYear({range:true,next:true})\">&#xe61b;</span></div><div mx-guid=\"ga\u001f\" class=\"mx3e3-_mx-calendar_index_-body\">11\u001d</div></div></div>","subs":[{"keys":["id","timeTypes","btns"],"path":"div[mx-guid=\"g0\u001f\"]","tmpl":"<div class=\"mx3e3-_mx-calendar_index_-header\"><span class=\"mx3e3-_mx-style_index_-iconfont mx3e3-_mx-calendar_index_-minus\" mx-click=\"\u001f\u001echangeMonth()\">&#xe61e;</span><h4 mx-guid=\"g1\u001f\" mx-click=\"\u001f\u001eshowMonths()\" class=\"mx3e3-_mx-calendar_index_-title\">2\u001d</h4><span class=\"mx3e3-_mx-style_index_-iconfont mx3e3-_mx-calendar_index_-plus\" mx-click=\"\u001f\u001echangeMonth({next:true})\">&#xe61b;</span></div><div class=\"mx3e3-_mx-calendar_index_-body\"><div mx-guid=\"g2\u001f\" class=\"mx3e3-_mx-calendar_index_-weeks mx3e3-_mx-style_index_-clearfix\">3\u001d</div><div mx-guid=\"g3\u001f\" class=\"mx3e3-_mx-calendar_index_-days mx3e3-_mx-style_index_-clearfix\">4\u001d</div></div><%if($$.timeTypes){%><div mx-guid=\"g4\u001f\" mx-view=\"mx-time/index?time=<%@$$.timeValue%>&types=<%@$$.timeTypes%>\" class=\"mx3e3-_mx-style_index_-clearfix mx3e3-_mx-calendar_index_-time\" mx-change=\"\u001f\u001esetTime()\"></div><%}%><%if($$.btns){%><div class=\"mx3e3-_mx-calendar_index_-footer\"><button class=\"mx3e3-_mx-style_index_-btn mx3e3-_mx-style_index_-btn-brand\" mx-click=\"\u001f\u001ehide({enter:true})\">确定</button><button class=\"mx3e3-_mx-style_index_-btn mx3e3-_mx-style_index_-ml5\" mx-click=\"\u001f\u001ehide()\">取消</button></div><%}%>","s":"1\u001d","attr":"id=\"days_<%=$$.id%>\"","attrs":[{"n":"id","p":1}],"mask":"211"},{"keys":["year","month"],"path":"h4[mx-guid=\"g1\u001f\"]","tmpl":"<%=$$.year%>-<%=$$.month<10?'0'+$$.month:$$.month%>","s":"2\u001d"},{"keys":["weekText"],"path":"div[mx-guid=\"g2\u001f\"]","tmpl":"<%for(var a=0;a<$$.weekText.length;a++){%><span class=\"mx3e3-_mx-calendar_index_-week\"><%=$$.weekText[a]%></span><%}%>","s":"3\u001d","l":1},{"keys":["days"],"path":"div[mx-guid=\"g3\u001f\"]","tmpl":"<%for(var b=0;b<$$.days.length;b++){%><%var c=$$.days[b]%><%for(var d=0;d<c.length;d++){%><span class=\"mx3e3-_mx-calendar_index_-day<%if(c[d].otherMonth){%> mx3e3-_mx-calendar_index_-gray<%}%><%if(c[d].disabled){%> mx3e3-_mx-calendar_index_-notallowed<%}%><%if(c[d].selected){%> mx3e3-_mx-calendar_index_-selected<%}%>\" <%if(!c[d].disabled){%> mx-click=\"\u001f\u001echoose({toMonth:<%=c[d].month%>,date:'<%=$eq(c[d].full)%>'})\" <%}%> title=\"<%=c[d].full%>\"><%=c[d].day%></span><%}%><%}%>","s":"4\u001d","l":1},{"keys":["timeValue"],"path":"div[mx-guid=\"g4\u001f\"]","pKeys":["timeTypes","btns"],"attr":"mx-view=\"mx-time/index?time=<%@$$.timeValue%>&types=<%@$$.timeTypes%>\"","attrs":[{"n":"mx-view","v":1}]},{"keys":["id"],"path":"div[mx-guid=\"g5\u001f\"]","attr":"id=\"months_<%=$$.id%>\"","attrs":[{"n":"id","p":1}]},{"keys":["year"],"path":"h4[mx-guid=\"g6\u001f\"]","tmpl":"<%=$$.year%>","s":"7\u001d"},{"keys":["months"],"path":"div[mx-guid=\"g7\u001f\"]","tmpl":"<%for(var e=0,f;e<$$.months.length;e++){%><%f=$$.months[e]%><span class=\"mx3e3-_mx-calendar_index_-ym<%if(f.disabled){%> mx3e3-_mx-calendar_index_-notallowed<%}%><%if(f.selected){%> mx3e3-_mx-calendar_index_-selected<%}%>\" <%if(!f.disabled){%> mx-click=\"\u001f\u001epickMonth({month:'<%=$eq(f.month)%>'})\" <%}%>><%=f.month%></span><%}%>","s":"8\u001d","l":1},{"keys":["id"],"path":"div[mx-guid=\"g8\u001f\"]","attr":"id=\"years_<%=$$.id%>\"","attrs":[{"n":"id","p":1}]},{"keys":["startYear","endYear"],"path":"h4[mx-guid=\"g9\u001f\"]","tmpl":"<%=$$.startYear%>-<%=$$.endYear%>","s":"10\u001d"},{"keys":["years"],"path":"div[mx-guid=\"ga\u001f\"]","tmpl":"<%for(var g=0,h;g<$$.years.length;g++){%><%h=$$.years[g]%><span class=\"mx3e3-_mx-calendar_index_-ym<%if(h.selected){%> mx3e3-_mx-calendar_index_-selected<%}%><%if(h.disabled){%> mx3e3-_mx-calendar_index_-notallowed<%}%><%if(!g||g==$$.years.length-1){%> mx3e3-_mx-calendar_index_-gray<%}%>\" <%if(!h.disabled){%> mx-click=\"\u001f\u001epickYear({year:'<%=$eq(h.year)%>'})\" <%}%>><%=h.year%></span><%}%>","s":"11\u001d","l":1}],"file":"mx-calendar/index.html"},
    init(extra) {
        let me = this;
        me.$extra = extra;
    },
