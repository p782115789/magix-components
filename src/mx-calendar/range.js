...
Magix.applyStyle("mx3e3_mx-calendar_range_",".mx3e3_mx-calendar_range_-wrapper {\n  border: 1px solid #e6e6e6;\n  padding: 10px 0;\n  border-radius: 4px;\n  background-color: #fff;\n  width: 265px;\n}\n.mx3e3_mx-calendar_range_-shortcuts-wrapper {\n  padding: 0 10px;\n}\n.mx3e3_mx-calendar_range_-st {\n  height: 24px;\n  line-height: 24px;\n  border-radius: 4px;\n  margin: 0 10px 10px 0;\n  width: 70px;\n  float: left;\n  text-align: center;\n  display: inline-block;\n  cursor: pointer;\n}\n.mx3e3_mx-calendar_range_-st:hover {\n  background: #e6e6e6;\n}\n.mx3e3_mx-calendar_range_-selected,\n.mx3e3_mx-calendar_range_-selected:hover {\n  color: #fff;\n  background: #6363e6;\n}\n.mx3e3_mx-calendar_range_-range {\n  padding: 0 10px;\n  margin-bottom: 15px;\n}\n.mx3e3_mx-calendar_range_-ipt {\n  background-color: #f0f0f0;\n  border: 0;\n  height: 24px;\n  width: 117px;\n  text-align: center;\n  display: inline-block;\n  color: #333;\n  border-radius: 4px;\n  padding: 6px 9px;\n  cursor: text;\n}\n.mx3e3_mx-calendar_range_-footer {\n  border-top: 1px solid #e6e6e6;\n  margin-left: 10px;\n  padding-top: 10px;\n  width: 92%;\n}\n.mx3e3_mx-calendar_range_-time {\n  width: 330px;\n}\n.mx3e3_mx-calendar_range_-time .mx3e3_mx-calendar_range_-ipt {\n  width: 150px;\n}\n");
...
let Range = Magix.View.extend({
    tmpl: {"html":"<div mx-guid=\"g0\u001f\" class=\"mx3e3_mx-calendar_range_-wrapper <%if($$.showTime){%> mx3e3_mx-calendar_range_-time <%}%>\">1\u001d</div>","subs":[{"keys":["showTime","quickDates"],"path":"div[mx-guid=\"g0\u001f\"]","tmpl":"<%if($$.quickDates.length){%><div class=\"mx3e3_mx-calendar_range_-shortcuts-wrapper\"><div class=\"mx3e3_mx-style_index_-mb10\">快捷日期</div><div mx-guid=\"g1\u001f\" class=\"mx3e3_mx-style_index_-clearfix\">2\u001d</div></div><%}%><div class=\"mx3e3_mx-calendar_range_-range\"><div class=\"mx3e3_mx-style_index_-mb10\">日期范围</div><div class=\"mx3e3_mx-style_index_-clearfix\"><input mx-guid=\"g2\u001f\" readonly=\"readonly\" class=\"mx3e3_mx-calendar_range_-ipt\" data-hidden=\"<%=$$.dates.startStr%>\" value=\"<%=$$.dates.startStr%>\" mx-click=\"\u001f\u001eshowDatepicker({first:true})\" id=\"start_<%=$$.id%>\" mx-change=\"\u001f\u001esync()\">-<input mx-guid=\"g3\u001f\" readonly=\"readonly\" class=\"mx3e3_mx-calendar_range_-ipt\" data-hidden=\"<%=$$.dates.endStr%>\" value=\"<%=$$.dates.endStr%>\" mx-click=\"\u001f\u001eshowDatepicker()\" id=\"end_<%=$$.id%>\" mx-change=\"\u001f\u001esync()\"></div></div><div class=\"mx3e3_mx-calendar_range_-footer mx3e3_mx-style_index_-clearfix\"><button mx-click=\"\u001f\u001epicked()\" type=\"button\" class=\"mx3e3_mx-style_index_-btn mx3e3_mx-style_index_-btn-brand\">确定</button><button mx-click=\"\u001f\u001ecancel()\" type=\"button\" class=\"mx3e3_mx-style_index_-btn mx3e3_mx-style_index_-ml5\">取消</button></div>","s":"1\u001d","attr":"class=\"mx3e3_mx-calendar_range_-wrapper <%if($$.showTime){%> mx3e3_mx-calendar_range_-time <%}%>\"","attrs":[{"n":"class","p":1,"f":"className"}],"mask":"21"},{"keys":["quickDates","quickDatesMap","dates"],"path":"div[mx-guid=\"g1\u001f\"]","tmpl":"<%for(var a=0;a<$$.quickDates.length;a++){%><%var b=$$.quickDates[a],c=$$.quickDatesMap[b]%><span class=\"mx3e3_mx-calendar_range_-st mx3e3_mx-style_index_-ellipsis <%if($$.dates.quickDateKey==b){%> mx3e3_mx-calendar_range_-selected <%}%>\" mx-click=\"\u001f\u001epicked({quick:true,key:'<%=$eq(b)%>'})\" title=\"<%=c?c.text:b%>\"><%=c?c.text:b%></span><%}%>","s":"2\u001d"},{"keys":["dates","id"],"path":"input[mx-guid=\"g2\u001f\"]","attr":"data-hidden=\"<%=$$.dates.startStr%>\" value=\"<%=$$.dates.startStr%>\" mx-click=\"\u001f\u001eshowDatepicker({first:true})\" id=\"start_<%=$$.id%>\"","attrs":[{"n":"data-hidden"},{"n":"value","q":1,"p":1},{"n":"mx-click"},{"n":"id","p":1}]},{"keys":["dates","id"],"path":"input[mx-guid=\"g3\u001f\"]","attr":"data-hidden=\"<%=$$.dates.endStr%>\" value=\"<%=$$.dates.endStr%>\" mx-click=\"\u001f\u001eshowDatepicker()\" id=\"end_<%=$$.id%>\"","attrs":[{"n":"data-hidden"},{"n":"value","q":1,"p":1},{"n":"mx-click"},{"n":"id","p":1}]}],"file":"mx-calendar/range.html"},
    init(ops) {
        let me = this;
        me.$min = ops.min;
        me.$max = ops.max;
