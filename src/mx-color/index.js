...
let pickerZone = 196;
let slider = 16 / 2;
Magix.applyStyle("mx3e3_mx-color_index_",".mx3e3_mx-color_index_-cnt{\n  padding:10px;\n  background-color: #fff;\n  display: inline-block;\n  border: 1px solid #CCC;\n  border-radius: 5px;\n  overflow-y: hidden;\n  z-index: 10;\n}\n\n.mx3e3_mx-color_index_-shortcuts {\n  width: 225px;\n}\n.mx3e3_mx-color_index_-shortcuts {\n  *zoom: 1;\n}\n.mx3e3_mx-color_index_-shortcuts:before,\n.mx3e3_mx-color_index_-shortcuts:after {\n  display: table;\n  content: \"\";\n}\n.mx3e3_mx-color_index_-shortcuts:after {\n  clear: both;\n}\n.mx3e3_mx-color_index_-shortcuts-item {\n  border: 1px solid #000;\n  float: left;\n  width: 15px;\n  height: 15px;\n  margin: -1px 0px 0 -1px;\n  display: inline;\n  position: relative;\n}\n.mx3e3_mx-color_index_-selected:before {\n  content: ' ';\n  position: absolute;\n  left: 2px;\n  top: 2px;\n  border:solid 2px #e8e8e8;\n  border-style: inset;\n  width:9px;\n  height: 9px;\n}\n.mx3e3_mx-color_index_-body{\n  margin:10px 0;\n  height: 200px\n}\n.mx3e3_mx-color_index_-cpicker-wrapper{\n  position: relative;\n  float:left;\n}\n.mx3e3_mx-color_index_-cpicker{\n  width:196px;\n  height:196px;\n}\n.mx3e3_mx-color_index_-cpicker-indicator{\n  position: absolute;\n  width:6px;\n  height:6px;\n  box-shadow: 0 0 0 1.5px #fff,inset 0 0 1px 1px rgba(0,0,0,.3),0 0 1px 2px rgba(0,0,0,.4);\n  border-radius: 50%;\n  cursor: default;\n}\n.mx3e3_mx-color_index_-slide-wrapper{\n  position: relative;\n  float:left;\n  margin-left:10px;\n}\n.mx3e3_mx-color_index_-slide{\n  width:20px;\n  height:196px;\n}\n.mx3e3_mx-color_index_-slide-indicator{\n  position: absolute;\n  left:4px;\n  top:-8px;\n  border: 8px solid transparent;\n  border-right-color: #888;\n  width:0;\n  height:0;\n  cursor: default;\n}\n.mx3e3_mx-color_index_-foot{\n  height: 25px;\n}\n.mx3e3_mx-color_index_-color-value{\n  width: 99px;\n  margin-right: 5px;\n  vertical-align: middle;\n}\n.mx3e3_mx-color_index_-bgcolor{\n  width: 50px;\n  height: 23px;\n  line-height: 23px;\n  display: inline-block;\n  margin-right: 10px;\n  vertical-align: middle;\n  border: 1px solid #ddd;\n}");
...
let CSSNames = {"selected":"mx3e3_mx-color_index_-selected","cnt":"mx3e3_mx-color_index_-cnt"};
...
module.exports = Magix.View.extend({
    tmpl: {"html":"<div mx-guid=\"g0\u001f\" id=\"shortcuts_<%=$$.id%>\"><ul mx-guid=\"g1\u001f\" class=\"mx3e3_mx-color_index_-shortcuts\">2\u001d</ul></div><div class=\"mx3e3_mx-color_index_-body\"><div class=\"mx3e3_mx-color_index_-cpicker-wrapper\"><div mx-guid=\"g2\u001f\" class=\"mx3e3_mx-color_index_-cpicker\" id=\"cpicker_<%=$$.id%>\" mx-click=\"\u001f\u001ecolorZoneClick()\"></div><div mx-guid=\"g3\u001f\" class=\"mx3e3_mx-color_index_-cpicker-indicator\" id=\"ph_<%=$$.id%>\" mx-mousedown=\"\u001f\u001edragPicker()\"></div></div><div class=\"mx3e3_mx-color_index_-slide-wrapper\"><div mx-guid=\"g4\u001f\" class=\"mx3e3_mx-color_index_-slide\" id=\"slide_<%=$$.id%>\" mx-click=\"\u001f\u001eslideClick()\"></div><div mx-guid=\"g5\u001f\" class=\"mx3e3_mx-color_index_-slide-indicator\" mx-mousedown=\"\u001f\u001edragSlide();\" id=\"sh_<%=$$.id%>\"></div></div></div><div class=\"mx3e3_mx-color_index_-foot\"><span mx-guid=\"g6\u001f\" class=\"mx3e3_mx-color_index_-bgcolor\" id=\"bgcolor_<%=$$.id%>\"></span><input mx-guid=\"g7\u001f\" class=\"mx3e3_mx-style_index_-input mx3e3_mx-color_index_-color-value\" readonly=\"readonly\" id=\"val_<%=$$.id%>\"><button class=\"mx3e3_mx-style_index_-btn mx3e3_mx-style_index_-btn-brand\" type=\"button\" mx-click=\"\u001f\u001eenter();\">确定</button></div>","subs":[{"keys":["id"],"path":"div[mx-guid=\"g0\u001f\"]","attr":"id=\"shortcuts_<%=$$.id%>\"","attrs":[{"n":"id","p":1}]},{"keys":["shortcuts","id"],"path":"ul[mx-guid=\"g1\u001f\"]","tmpl":"<%for(var a=0;a<$$.shortcuts.length;a++){%><li class=\"mx3e3_mx-color_index_-shortcuts-item\" id=\"sc_<%=$$.shortcuts[a]%>_<%=$$.id%>\" style=\"background:#<%=$$.shortcuts[a]%>\" mx-click=\"\u001f\u001epickShortcuts({color:'#<%=$eq($$.shortcuts[a])%>'})\"></li><%}%>","s":"2\u001d"},{"keys":["id"],"path":"div[mx-guid=\"g2\u001f\"]","attr":"id=\"cpicker_<%=$$.id%>\"","attrs":[{"n":"id","p":1}]},{"keys":["id"],"path":"div[mx-guid=\"g3\u001f\"]","attr":"id=\"ph_<%=$$.id%>\"","attrs":[{"n":"id","p":1}]},{"keys":["id"],"path":"div[mx-guid=\"g4\u001f\"]","attr":"id=\"slide_<%=$$.id%>\"","attrs":[{"n":"id","p":1}]},{"keys":["id"],"path":"div[mx-guid=\"g5\u001f\"]","attr":"id=\"sh_<%=$$.id%>\"","attrs":[{"n":"id","p":1}]},{"keys":["id"],"path":"span[mx-guid=\"g6\u001f\"]","attr":"id=\"bgcolor_<%=$$.id%>\"","attrs":[{"n":"id","p":1}]},{"keys":["id"],"path":"input[mx-guid=\"g7\u001f\"]","attr":"id=\"val_<%=$$.id%>\"","attrs":[{"n":"id","p":1}]}],"file":"mx-color/index.html"},
    init(extra) {
        let me = this;
