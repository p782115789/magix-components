...
Magix.applyStyle("mx3e3_mx-time_picker_",".mx3e3_mx-time_picker_-wrapper {\n  position: absolute;\n  display: none;\n  border: 1px solid #e6e6e6;\n  padding: 10px 0;\n  border-radius: 4px;\n  background-color: #fff;\n  z-index: 1;\n  width: 271px;\n}\n.mx3e3_mx-time_picker_-time {\n  margin: 0 10px;\n}\n.mx3e3_mx-time_picker_-footer {\n  border-top: 1px solid #e6e6e6;\n  margin: 10px 10px 0;\n  padding: 10px 0 0 0;\n}\n");
module.exports = Magix.View.extend({
    tmpl: {"html":"<div mx-guid=\"g0\u001f\" class=\"mx3e3_mx-time_picker_-wrapper\" id=\"wrapper_<%=$$.viewId%>\"><div mx-guid=\"g1\u001f\" mx-view=\"mx-time/index?time=<%@$$.time%>&types=<%@$$.types%>\" view-time view-types id=\"time_<%=$$.viewId%>\" class=\"mx3e3_mx-time_picker_-time mx3e3_mx-style_index_-clearfix\" mx-change=\"\u001f\u001etake()\"></div><div class=\"mx3e3_mx-time_picker_-footer\"><button class=\"mx3e3_mx-style_index_-btn mx3e3_mx-style_index_-btn-brand\" mx-click=\"\u001f\u001ehide({enter:true})\">确定</button><button class=\"mx3e3_mx-style_index_-btn mx3e3_mx-style_index_-ml5\" mx-click=\"\u001f\u001ehide()\">取消</button></div></div>","subs":[{"keys":["viewId"],"path":"div[mx-guid=\"g0\u001f\"]","attr":"id=\"wrapper_<%=$$.viewId%>\"","attrs":[{"n":"id","p":1}]},{"keys":["time","types","viewId"],"path":"div[mx-guid=\"g1\u001f\"]","attr":"mx-view=\"mx-time/index?time=<%@$$.time%>&types=<%@$$.types%>\" view-time view-types id=\"time_<%=$$.viewId%>\"","attrs":[{"n":"mx-view","v":1},{"n":"view-time"},{"n":"view-types"},{"n":"id","p":1}]}],"file":"mx-time/picker.html"},
    init(extra) {
        let me = this;
        Monitor.setup();
        let oNode = $('#' + me.id);
